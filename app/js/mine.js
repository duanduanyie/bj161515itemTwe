...
for(var i = 0; i < jifenNum; i++){
	...
	jfTd1.innerText = "2017-05-15 16:20:10";
	jfTd2.innerText = "+80";
...
for(var i = 0; i < mineStarNum; i++){
	addBox_tj("one.html","../images/img/commodity1.png","自家礼包送亲人，送朋友的不二选择，自家礼包打着销售","11.8","20.0",".mine_star_wrap");
}
...
for(var i = 0; i < mineResNum; i++){
	addBox_zuijin("one.html","../images/img/commodity1.png","自家礼包送亲人，送朋友的不二选择，自家礼包打着销售","11.8","20.0",".mine_res_see");
}
...
for(var i = 0; i < mineAddNum; i++){
	mineAddBox("1","段哥","北京 昌平区","蓝鸥科技","000000","无","###","###");
}
